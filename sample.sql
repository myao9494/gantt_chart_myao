...
CREATE TABLE IF NOT EXISTS `gantt_tasks` (
  ...
  `price_or_target_price` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `loss_cut_price` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `loss_cut_reason` text COLLATE utf8_unicode_ci DEFAULT NULL,
